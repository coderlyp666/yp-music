...
__DEFINE__(1670244307707, function(require, module, exports) {
module.exports = {
  HYEventBus: require('./event-bus'),
  HYEventStore: require('./event-store')
}

}, function(modId) {var map = {"./event-bus":1670244307708,"./event-store":1670244307709}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1670244307708, function(require, module, exports) {
class HYEventBus {
  constructor() {
    this.eventBus = {}
  }
...
__DEFINE__(1670244307709, function(require, module, exports) {
...
}, function(modId) { var map = {"./event-bus":1670244307708,"./utils":1670244307710}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1670244307710, function(require, module, exports) {
...
return __REQUIRE__(1670244307707);
})()
