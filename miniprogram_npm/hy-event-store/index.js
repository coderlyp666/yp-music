...
__DEFINE__(1669730042028, function(require, module, exports) {
module.exports = {
  HYEventBus: require('./event-bus'),
  HYEventStore: require('./event-store')
}

}, function(modId) {var map = {"./event-bus":1669730042029,"./event-store":1669730042030}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1669730042029, function(require, module, exports) {
class HYEventBus {
  constructor() {
    this.eventBus = {}
  }
...
__DEFINE__(1669730042030, function(require, module, exports) {
...
}, function(modId) { var map = {"./event-bus":1669730042029,"./utils":1669730042031}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1669730042031, function(require, module, exports) {
...
return __REQUIRE__(1669730042028);
})()
